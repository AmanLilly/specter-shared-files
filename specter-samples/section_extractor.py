...
if __name__ == "__main__":
    file_path = "Investigator-Site.txt"  # Update path as needed
    sections = extract_sections('/Users/L091007/codebase/specter-shared-files/specter-samples/Investigator-Site.txt')
